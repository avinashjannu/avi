...
public class udpatecropdetail
{
    public static int updatecropdetail(crop cr)
    {
	...
	{   
		...
		stm.setString(1, cr.getcrq_id());
                stm.setString(2, cr.getstatus());
                ...
                {
                     Logger.getLogger(udpatecropdetail.class.getName()).log(Level.SEVERE, null, ex);
                } 
